// Mumble.h - GW2's Mumble Link data, as exposed pre-parsed via Nexus's own
// DataLink API (DL_MUMBLE_LINK) rather than the raw shared-memory blob.
//
// Vendored from RaidcoreGG's Nexus-API-consuming addons (matches the
// WvWTracker project's copy verbatim), since this isn't part of Nexus.h
// itself - Nexus just documents that DL_MUMBLE_LINK/EV_MUMBLE_IDENTITY_UPDATED
// payloads are shaped like this.
#ifndef MUMBLE_H
#define MUMBLE_H
