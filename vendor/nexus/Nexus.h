...
///----------------------------------------------------------------------------------------------------
//
// Vendored verbatim from https://github.com/RaidcoreGG/Nexus-API (Nexus.h),
// fetched 2026-07-01. This is the repo the official Nexus-Template-cpp
// submodules as its addon SDK. Note: that template's example entry.cpp uses
// older nested-group field names (e.g. Renderer.Register, DataLink.Get)
// that don't match this current flat-field header (e.g. GUI_Register,
// DataLink_Get) - the template's sample code is stale relative to this
// header. main.cpp in this project is written against the field names
// actually declared below.
